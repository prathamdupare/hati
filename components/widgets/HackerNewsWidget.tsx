import { HackerNewsWidgetConfig } from "@/lib/hati/types";
import {
  Card,
  CardContent,
...
async function fetchHNItems(limit: number): Promise<HNItem[]> {
  try {
...
export async function HackerNewsWidget({ config }: { config: HackerNewsWidgetConfig }) {
